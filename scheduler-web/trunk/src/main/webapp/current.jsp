...
<%
	...
	RegistOffering offering=new RegistOffering(prefix+"CLASSES-2004-SECOND-CMSC");
	
	wis.load();
	offering.load();
	
	scheduler = new ScheduleValidator(offering,wis.getWriteIns());
	scheduler.loadForm5(prefix+"FORM5-2004-SECOND-CMSC-MAS");
...
//	double p=stat.getPercentageLoad(stdNum);
	ite1=skedule.getSectionAssignments().keySet().iterator();
	while (ite1.hasNext()){
		String subject=(String)ite1.next();
		SectionAssignment sectAss=(SectionAssignment)skedule.getSectionAssignment(subject);
